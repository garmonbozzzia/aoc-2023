// https://github.com/DevInsideYou/scala-seed.g8/blob/master/src/main/g8/aliases.sbt
...
addCommandAlias("np", "g8Scaffold project")
addCommandAlias("day", "cd root; g8Scaffold day")
